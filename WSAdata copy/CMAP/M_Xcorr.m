%previously know as marcio2_j02.m
...
limiar=0.007;       %threshold for what is considered a reponses 0.0145 sem filtros
...
for i = 1:size(C4media,2),    
    if (C4media(i)>=2*C4std(i) & C4media(i)> limiar),
    pks(i)=C4media(i);
    end
end
