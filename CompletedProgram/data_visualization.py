...
# dataframe of means
df = pd.DataFrame(index=['1 - Control', '2 - 1 nM', '3 - 10 nM', '4 - 50 nM', '5 - 100 nM', '6 - 200 nM', '7 - 400 nM', '8 - 600 nM', '9 - 1 uM'],
                  data={'mine': [0.327550258, 0.288936793, 0.329, 0.24, 0.20, 0.215, 0, 0, 0],
                        'hieu': [0.342806646, 0.266375129, 0.331, 0.25, 0.21, 0.22, 0, 0, 0]})
# dataframe of medians
df_1 = df
df_1['mine'] = [0.319019154, 0.248037378, 0.325, 0.24, 0.20, 0.215, 0, 0, 0]
df_1['hieu'] = [0.319850276, 0.234918587, 0.336, 0.25, 0.21, 0.22, 0, 0, 0]
